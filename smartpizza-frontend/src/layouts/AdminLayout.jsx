...
import { LayoutDashboard, TrendingUp, ClipboardList, Pizza, Ticket, Users, Truck, LogOut, Menu, X, User, Edit3, Save, Mail, Phone, ChevronDown, Loader2 } from 'lucide-react'
...
export const AdminLayout = () => {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <aside style={{
        width: 260, minHeight: '100vh', position: sidebarOpen ? 'fixed' : 'relative',
      ...
      >
        <Link to="/admin" style={{ color: '#fff', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1.75rem', fontFamily: 'var(--font-display)', fontSize: '1.2rem' }}>
        ...
        <div ref={dropdownRef} style={{ position: 'relative' }}>
          <button onClick={() => setShowDropdown(!showDropdown)} style={{
            ...
            <User size={15} /> <span style={{ flex: 1, textAlign: 'left' }}>{user?.name || user?.username || 'Account'}</span>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        >
          ...
          <span style={{ fontFamily: 'var(--font-display)', fontSize: '1.1rem' }}>Admin Panel</span>
          <ThemeToggle />
        </nav>
